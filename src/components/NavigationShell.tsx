          ...
          <div className='flex items-center gap-1.5'>
            {aiEnabled && (
              <button
                ...
                className='relative p-1.5 rounded-lg bg-linear-to-br from-green-500 to-blue-600 text-white hover:from-green-600 hover:to-blue-700 active:scale-95 transition-all duration-200 shadow-lg shadow-blue-500/30 group'
                aria-label='AI 推荐'
              >
